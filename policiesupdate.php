...
<?php
 ...
 $query = "update policies set policy_no='$policy_no',agent_id='$agent_id',customer_id='$customer_id',type='$type',insured_date='$insured_date',effective_date='$effective_date',insured_amount='$insured_amount',face_value='$face_value',premium='$premium' where policy_no='$policy_no'";
